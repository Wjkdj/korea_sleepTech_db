...
# 3. 도메인 무결성
# : 테이블의 각 필드(열, 컬럼)가 정의된 도메인에 맞는 값ㅇ르 가져야 함을 뜻함
# : 테이터 타입, 포맷, 범위 등이 적잘하게 유지
# : 도메인은 '데이터 타입, 길이, 가능한 값의 범위'로 구성
# - 테이터 타입 지정, 제한 조건(check), unsigned 등을 통해 구현
